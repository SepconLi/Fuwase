...
USING (VALUES
    ('gerardo.murillo07@gmail.com', 'gerarmuri07', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 75894521, 'Personal'),
    ('emiliavez@gmail.com', 'EmiChavez23', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 88569845, 'Personal'),
    ('karen.hidalgo44@hotmail.com', 'kahi_44', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 69562345, 'Personal'),
    ('ramirezjosher@gmail.com', 'Josher_Ramirez', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 23568978, 'Personal'),
    ('sodaDoñaJulia@hotmail.com', 'soda_DJ', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 24569878, 'Business'),
    ('walmart@hotmail.com', 'WalmartCR', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 24986587, 'Business'),
    ('foodWasteUCR@gmail.com', 'SuperAdmin', '$2a$11$xOUF.IktAa6Bxwx0Mtz5/OAUkkPrbS3kA3QQvMotsa.gXGyGL/ug2', 10000000, 'Admin'),
    ('ximena.gdur@gmail.com', 'Ximena_Gdur', 'Patito.20', 65030608, 'Personal'),
    ('mariana.murilloquintana@ucr.ac.cr', 'Mariana_Murillo', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 25659878, 'Personal'),
    ('valery.murcia@ucr.ac.cr', 'Valery_Muria', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 89562301, 'Personal'),
    ('aaron@gmail.com', 'Aaron_Campos', '$2a$11$8JTcEDSLD6xdAFJr/YlAY.RD1gGg79JD/JmBqNqXbQBsc/jLrrn0.', 75451265, 'Personal')
    )
AS Source ([Email], [UserName], [Password], [PhoneNumber], [Role]) ON Target.[Email] = Source.[Email]
WHEN NOT MATCHED BY TARGET THEN
INSERT ([Email], [UserName], [Password], [PhoneNumber], [Role])
VALUES ([Email], [UserName], [Password], [PhoneNumber], [Role]);

MERGE INTO Client AS Target
USING (VALUES
    ('gerardo.murillo07@gmail.com', 'Alajuela', 'Zarcero', 'Palmira'),
    ('emiliavez@gmail.com', 'Cartago', 'Paraiso', 'Orosi'),
    ('karen.hidalgo44@hotmail.com', 'Puntarenas', 'Buenos Aires', 'Colinas'),
    ('ramirezjosher@gmail.com', 'Curridabat','Curridabat','San Jose'),
    ('sodaDoñaJulia@hotmail.com', 'Pital','San Carlos','Alajuela'),
    ('walmart@hotmail.com', 'San Francisco de Dos Rios','San Jose','San Jose'),
    ('ximena.gdur@gmail.com', 'Guanacaste', 'Tilaran', 'Quebrada Grande'),
    ('mariana.murilloquintana@ucr.ac.cr','Puntarenas', 'Osa', 'Bahia Ballena'),
    ('valery.murcia@ucr.ac.cr', 'Cartago', 'Cartago', 'Dulce Nombre'),
    ('aaron@gmail.com', 'Alajuela', 'Orotina', 'Hacienda Vieja')
    )
...
USING (VALUES
    ...
    ('karen.hidalgo44@hotmail.com', '256983254', 'Karen', 'Hidalgo'),
    ('ramirezjosher@gmail.com', '402051568', 'Josher','Ramírez'),
    ('ximena.gdur@gmail.com', '512689045', 'Ximena', 'Gdur'),
    ('mariana.murilloquintana@ucr.ac.cr','612549806', 'Mariana', 'Murillo'),
    ('valery.murcia@ucr.ac.cr', '312359804', 'Valery', 'Murcia'),
    ('aaron@gmail.com', '256350402', 'Aaron', 'Campos')
    )
